...
public class ToughEnoughComponents implements ItemComponentInitializer, EntityComponentInitializer {
    ...
    public static final ComponentKey<Drinkable> DRINKABLE = ComponentRegistryV3.INSTANCE.getOrCreate(identifier("drinkable"), Drinkable.class);
    ...
    public void registerItemComponentFactories(ItemComponentFactoryRegistry registry) {
        ...
        registry.registerFor(item -> item == ToughEnoughItems.CANTEEN_ITEM, DRINKABLE, ((item, stack) -> new DefaultDrinkable(2, 5.0F)));
    }
}
