...
public class ToughEnoughBlockEntities {
    ...
    public static final BlockEntityType<ClimatizerEntity> CLIMATIZER_ENTITY_TYPE;

    static {
        CLIMATIZER_ENTITY_TYPE = Registry.register(Registry.BLOCK_ENTITY_TYPE, ToughEnough.identifier("climatizer"), BlockEntityType.Builder.create(ClimatizerEntity::new, ToughEnoughBlocks.CLIMATIZER).build(null));
